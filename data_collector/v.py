...
def main(base_path: str, screen_height_mm_offset: int = 10):
    ...
    face_model_all_transformed = get_face_landmarks_in_ccs(camera_matrix, dist_coeffs, image.shape, results)
